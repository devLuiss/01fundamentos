  ...
  },
  {
    ...
    content: [
      {type: "paragraph", content: "Hi everyone 🤖"},
      {
        type: "paragraph",
        content:
          "Just released a new machine learning model for image recognition. Check it out at john.science/image-rec",
      },
  ...
  },
  {
    ...
    content: [
      {type: "paragraph", content: "Hello friends 🚀"},
      {
        type: "paragraph",
        content:
          "Just deployed a new application on Kubernetes. Check it out at sarah.dev/k8s-app",
      },
  ...
  },
  {
    ...
    content: [
      {type: "paragraph", content: "Hey there 🔥"},
      {
        type: "paragraph",
        content:
          "Just finished a new e-commerce project. Check it out at mike.store/ecommerce",
      },
  ...
  },
  {
    ...
    content: [
      {type: "paragraph", content: "Hello everyone 🎨"},
      {
        type: "paragraph",
        content:
          "Just released a new website design. Check it out at jane.design/new-project",
      },
  ...
  },
  {
    ...
    content: [
      {type: "paragraph", content: "Hi there 📱"},
      {
        type: "paragraph",
        content:
          "Just released a new mobile app. Check it out at tom.app/new-app",
      },
  ...
  },
  {
    ...
    content: [
      {type: "paragraph", content: "Hello there 💻"},
      {
        type: "paragraph",
        content:
          "Just finished a new REST API. Check it out at alex.dev/new-api",
      },
